...
/* STEP 8: Validating the CRC Model
/* -----------------------------------------------------------
/***********************************************/
...
PROC SCORE
	DATA=WK17.CRC_VALIDATION_SAMPLE
	SCORE=WK17.CRC_HANDLE_LINEAR_MODEL
	PREDICT OUT=WK17.CRC_VALIDATION_SAMPLE_PRED
	TYPE=parms;
	VAR
		wps_pool
		total_pool_sum
...
DATA WK17.CRC_VALIDATION_PRED_DIFF;
	SET WK17.CRC_VALIDATION_SAMPLE_PRED(KEEP=handle CRC_TRACK);
	Diff = handle - CRC_TRACK;
RUN;
