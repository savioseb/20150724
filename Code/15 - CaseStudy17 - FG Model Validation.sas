...
/* STEP 12: Validating the FG Model
/* -----------------------------------------------------------
/***********************************************/
...
/** Testing the Validation Sample Dataset with the FG Model created in the previous step **/
PROC SCORE
	DATA=WK17.FG_VALIDATION_SAMPLE
	SCORE=WK17.FG_HANDLE_LINEAR_MODEL
	PREDICT OUT=WK17.FG_VALIDATION_SAMPLE_PRED
	TYPE=parms;
	VAR
		wps_pool
		total_pool_sum
...
DATA WK17.FG_VALIDATION_PRED_DIFF;
	SET WK17.FG_VALIDATION_SAMPLE_PRED(KEEP=handle FG_TRACK);
	Diff = handle - FG_TRACK;
RUN;
